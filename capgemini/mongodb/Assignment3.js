                                //MongoDB – Complex Queries Assignment -3
...
4.	 db.addresses.aggregate([{$project: {restaurant_id:1, name:1, borough:1, cuisine:1, "address.zipcode": 1, _id:0 }}]).pretty()
...
11.	 db.addresses.find({ "cuisine" : {$ne : "American "}, "grades.score" :{$gt: 70},"address.coord" : {$lt : -65.754168}}).pretty()
...
18.	 db.addresses.find( {"borough" :{$in :["Staten Island","Queens","Bronx","Brooklyn" ]}}, { "restaurant_id" : 1, "name":1,"borough":1, "cuisine" :1}).pretty() 
19.	 db.addresses.find( {"borough" :{$nin :["Staten Island","Queens","Bronx","Brooklyn" ]}}, { "restaurant_id" : 1, "name":1,"borough":1, "cuisine" :1}).pretty()
20.	 db.addresses.find({"grades.score": {$not: {$gt: 10}}},{"restaurant_id": 1, "name": 1, "borough": 1, "cuisine": 1}).pretty()
21.	 db.addresses.find({$or: [{name: /^Wil/}, {"$and": [{"cuisine": {$ne :"American "}}, {"cuisine" : {$ne :"Chinees"}}]}]}, {"restaurant_id" : 1, "name":1, "borough":1, "cuisine":1 }).pretty() 
...
24.	 db.restaurants.find({ "address.coord.1": {$gt : 42, $lte : 52}}, {"restaurant_id" : 1, "name":1,"address":1,"coord":1}).pretty()
...
31.	 db.addresses.find({ name : { $regex : "mon.*"}}, { "name":1, "borough": 1, "address.coord":1, "cuisine" :1}).pretty()
32.	 db.addresses.find({name : { $regex : /^Mad/}}, {"name":1, "borough":1, "address.coord":1, "cuisine" :1 }).pretty()
